...
const LazyEditProjectForm = lazy(() => 
  import('./EditProjectForm').then(module => ({
    default: (module as any).default || (module as any).EditProjectForm || ErrorFallback
  })).catch(() => ({
...
const LazyProjectModal = lazy(() => 
  import('./ProjectModal').then(module => ({
    default: (module as any).default || (module as any).ProjectModal || ErrorFallback
  })).catch(() => ({
...
const LazyApplicationModal = lazy(() => Promise.resolve({ default: ApplicationModalFallback }));
const LazyMyApplications = lazy(() => Promise.resolve({ default: MyApplicationsFallback }));
const LazyStatsCards = lazy(() => Promise.resolve({ default: StatsCardsFallback }));
